...
import pl.edu.agh.apdvbackend.mappers.field.without_id.FieldWithoutIdMapper;
...
public class GetUserEndpointDataWithFieldsImpl implements GetUserEndpointDataWithFields {
    ...
    public EndpointWithField execute(
        ...
        final var fieldsWithoutId = fieldWithoutIdMapper.fieldListToWithoutIdList(fields);
