...
class _MultiDataChartState extends State<MultiDataChart> {
  ...
  Container buildSimpleDivider(BuildContext context) {
    return Container(
  ...
  charts.TimeSeriesChart buildChart() {
    return charts.TimeSeriesChart(
            ...
            animate: false,
            behaviors: [
              charts.SeriesLegend.customLayout(CustomLegendBuilder())
            ],
          );
  }

  Center buildChartHeader() {
    return Center(
        child: Container(
