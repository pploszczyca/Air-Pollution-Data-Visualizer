import 'package:adpv_frontend/Providers/edit_endpoint_provider.dart';
...
class AdminEditEndpointView extends StatefulWidget {
...
class _AdminEditEndpointViewState extends State<AdminEditEndpointView> {
  ...
  void _addMeasurement(EditEndpointProvider provider, BuildContext context) {
    showDialog(
      context: context,
      builder: (context) {
