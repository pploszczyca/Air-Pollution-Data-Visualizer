...
Container buildDeleteContainer(Function onDeletePressed, arguments) =>
    Container(
...
Container buildEditContainer(Function onEditPressed, arguments) => Container(
      alignment: Alignment.centerRight,
      padding: const EdgeInsets.symmetric(vertical: 20, horizontal: 20),
      child: OutlinedButton(
        style: ButtonStyle(
        ...
        onPressed: () => onEditPressed(arguments),
      ),
    );
